      ...
      <div className="w-full max-w-md space-y-8 rounded-lg border p-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Get 5 credits on signup + 5 more with newsletter
          </p>
        </div>

        {/* OAuth buttons */}
        <div className="space-y-3">
          <button className="flex w-full items-center justify-center gap-3 rounded-md border px-4 py-2 text-sm font-medium hover:bg-accent">
        ...
        <form className="space-y-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <label htmlFor="newsletter" className="text-sm text-muted-foreground">
              Subscribe to newsletter (+5 bonus credits)
            </label>
          </div>
